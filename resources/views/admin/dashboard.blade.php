    ...
    <main class="main" id="top">
      <div class="container-fluid px-0">
          ...
          <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                <li class="nav-item"><a class="nav-link active" href="{{ url('categs') }}">
                ...
                <li class="nav-item"><a class="nav-link active" href="{{ url('users') }}">
                ...
                <li class="nav-item"><a class="nav-link active" href="{{ url('reviews') }}">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="cast"></span></span><span class="nav-link-text">avis</span></div>
                  </a>
                </li>
          ...
          <div class="navbar-logo"><button class="btn navbar-toggler navbar-toggler-humburger-icon" type="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalCollapse" aria-controls="navbarVerticalCollapse" aria-expanded="false" aria-label="Toggle Navigation"><span class="navbar-toggle-icon"><span class="toggle-line"></span></span></button> <a class="navbar-brand me-1 me-sm-3" href="index.html">
              <div class="d-flex align-items-center">
                <div class="d-flex align-items-center">
                  ...
                  <p class="logo-text ms-2 d-none d-sm-block">Review web</p>
                    </a>
                </div>
              </div>
            </a></div>
          <div class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav navbar-nav-icons ms-auto flex-row">
              ...
              <li class="nav-item dropdown"><a class="nav-link lh-1 px-0 ms-5" id="navbarDropdownUser" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-l"><img class="rounded-circle" src="{{ asset("dashassets/img/logout.png") }}" alt=""></div>
                </a>
                <div class="dropdown-menu dropdown-menu-end py-0 dropdown-profile shadow border border-300" aria-labelledby="navbarDropdownUser">
                    <div class="card bg-white position-relative border-0">
                        <div class="card-body p-0 overflow-auto scrollbar" style="height: 7rem;">
                        </div>
        ...
        <div class="content">
          <div class="pb-5">
            <div class="row g-5">
                <a href="{{ url('categs/create') }}" class="btn btn-primary">Ajouter Categorie</a>
                <a href="{{ url('products/create') }}" class="btn btn-primary">Ajouter Produit</a>
            </div>
            </div>
          </div>
          <footer class="footer">
